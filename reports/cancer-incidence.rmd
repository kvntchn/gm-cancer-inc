...
This packet summarizes Cox proportional hazard model results relating cumulative exposure to straight, soluble, and synthetic metalworking fluids (MWF) to cancer incidence of 14 types and for all sites combined (includes types not shown here) in the UAW-GM Cohort.
