...
race_coef.tab[,-c("Covariate", 'events')] %>% xtable(
				...
				caption = paste0("Adjusted HR estimates for ",
												 "incidence of the indicated outcome, associated with race. Caution: these estimates are simply the conditional estimates from the previous table.")
			) %>% print.xtable(
				# hline.after = c(-1, 0,
				# 								nrow(.) - c(11),#,9,6,3),
				# 								nrow(.)),
