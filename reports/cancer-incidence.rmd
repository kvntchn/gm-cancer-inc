...
\includegraphics[width=7.95in]{"`r here::here(paste0("reports/resources/Lag ", exposure.lag), paste0("str", ifelse(is.finite(messy_sol),
						 paste0("_sol", messy_sol %/% .01), ""), ".M50_facet.pdf"))`"}
\end{figure}
...
\label{fig:hwse}
\centering
\includegraphics{"`r here::here(paste0("reports/resources/hwse 2/FU through 1994/Lag ", 1 + hwse2.additional.lag, "/indexed by age"), paste0("hwse", paste0("_sol", messy_sol %/% .01), ".M50_facet.pdf"))`"}
\end{figure}
...
invisible(
	...
	ifelse(spline_year,
		...
		dir.names <- paste0(c("Binary", paste("Age", seq(50, 60, 5))), "/mi race")
		invisible(
		sapply(1:length(tab.names), function (i = 1) {
			assign(tab.names[i],
						 readRDS(
