...
\label{fig:str}
\centering
\includegraphics[width=8in]{"`r here::here(paste0("reports/resources/Lag ", exposure.lag), paste0("str", ifelse(is.finite(messy_sol),
...
\label{fig:sol}
\centering
\includegraphics[width=8in]{"`r here::here(paste0("reports/resources/Lag ", exposure.lag), paste0("sol", ifelse(is.finite(messy_sol),
						 paste0("_sol", messy_sol %/% .01), ""), "_facet.pdf"))`"}
\end{figure}
...
\label{fig:syn}
\centering
\includegraphics[width=8in]{"`r here::here(paste0("reports/resources/Lag ", exposure.lag),  paste0("syn", ifelse(is.finite(messy_sol),
						 paste0("_sol", messy_sol %/% .01), ""), "_facet.pdf"))`"}
\end{figure}
